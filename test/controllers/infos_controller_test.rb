...
class InfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create info" do
    assert_difference("Info.count") do
      post infos_url, params: { info: { Address: @info.Address, Email: @info.Email, Name: @info.Name, Nine_Hundred_Number: @info.Nine_Hundred_Number, Phone: @info.Phone } }
    end
  ...
  test "should update info" do
    patch info_url(@info), params: { info: { Address: @info.Address, Email: @info.Email, Name: @info.Name, Nine_Hundred_Number: @info.Nine_Hundred_Number, Phone: @info.Phone } }
